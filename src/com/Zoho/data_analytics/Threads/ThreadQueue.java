...
public class ThreadQueue{
    ...
    public void addThreads(String fileName, FileBufferReader fileBufferReader){
        fileStatus.add("New");
...
//        }
        System.out.println(fileName+" "+threadCall.getName());
    }
...
//        }
    ...
    synchronized public static void delThreads(int index){
